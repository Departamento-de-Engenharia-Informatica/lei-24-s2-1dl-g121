...
public class Vehicle {
    ...
    public Vehicle(String brand, String model, String type, double tareWeight, double grossWeight, String registerDate, String acquisitionDate, double maintenanceFrequencyKm) {
        this.brand = brand;
        this.model = model;
        this.type = type;
